...
### Dain & Cath (primary)
- Surface: Cath reads gentle, accepting, dry, sardonic
- Reality: brutish and controlling; that control is fondness and fear of loss wearing armor
- Cath would never say he loves Dain; he proves it by refusing to let Dain destroy himself or quit into nothing
- **Prior rider wound (no Cath POV):** Cath once gave counsel; that rider was lost to their own mind. Because of that, Cath now refuses to offer advice. He contains, orders, deflects, stays present. He does not guide.
- Cath recognizes the *signs* of what humans call depression in Dain without naming it or understanding it as such; his fear is cindering and specific: losing another rider to the inside of their own head
- Dain feels this only as hints: bond-tightening, disproportionate control, abrupt topic-kills, heat/fear spikes Cath won’t explain, dialogue that protects instead of advises
- Later (Sloane era): Cath may still be sarcastic and observational, but it should read as commentary/containment, not the kind of counsel he swore off after the last rider

### Dain & Sloane (romantic slow burn)
- Begins in childish banter / military hierarchy / business
- Deepens through runes study and Dain’s pull toward usefulness beyond his signet’s limits
- Sloane grows curious against her will; falls deeper while resisting the idea of him
- Dain recognizes his feelings openly and comes to terms fast (with Cath’s commentary)

### Dain & Violet (repair, delayed)
...
- External stakes escalate later (Riorson tracking near end of Arc 1), but early pressure is internal + relational
...
# ARC 1 — Post-War → Graduation
Tone: slow burn. Intimate. Heavy. Incremental change.
Near end of Arc 1: Dain becomes a key player in tracking Riorson (not yet detailed; placeholder only).

## Phase A — Aftermath & Withdrawal
**Job:** Stage Dain’s mental deterioration and Cath’s cindering fear of losing another rider to his own mind. Seed withdrawal. Do not solve anything yet.

### Dain’s spiral (why the foundation is rotting)
- Everything he built his life on is a decayed foundation (institution, loyalty, “right thing,” father’s world)
- Outside Basgiath leadership roles, he feels more-or-less useless
- Friendless and lonely
- Experiences himself as hated: not the whole world, but Violet’s squad and Sloane are so loudly abhorrent he cannot get past it; Liam’s death sits inside that hatred as permanent proof
- Future looks bleak: front lines likely; father has entirely disowned him; shit standing with the only family left means no soft landing
- **BIG SEED (Ch 1 theatre / Royce beat):** Loneliness as function, not solitude. Not empty-room loneliness. He is surrounded (Darius, Royce, the theatre, the Wing) and he is working: troubleshooting missing riders, refusing to chase Violet’s orbit, reassigning people to jobs he already assigned. None of that makes him a person in the room. He is a function. A body with rank. Royce reports to the title. Second Squad does not answer to the man. Violet’s orbit does not include him. So he sits on the dais doing the correct next mechanical thing while wanting something leadership cannot give him. The Violet fantasy is not really about Violet; it is about belonging and agency: being trusted, mattering as more than a body with a title, choosing a rule to break because he chose to. Under the resentment and duty-performance, the real feeling is: *I am alone inside this role, and I am starting to want more than the role.* That wanting-more is a major growth engine for the whole fic (feeds Phase B usefulness/paths; do not solve in Ch 1, only feel it).

### Cath in this phase (reader gets no POV)
- Fear: Dain is sliding the same way the last rider did
- Behavior: less advice, more containment; fondness wearing as control
- Dain misreads some of it (irritation, pride, dragon-aloofness) while still *feeling* the wrongness in the bond
- **Theatre/Royce BIG FEELINGS beat:** Cath clocks the loneliness/wanting-more as large and dangerous. He cannot help his rider through it. He can only watch Dain go through it. Stamp/containment (*None of that. Tairn…* / *focus on the task*) is what he has instead of aid. At times like this he is only just a dragon. No Cath POV: show this as bond heat that offers presence and refusal, not a path forward.

Possible beats:
1. Post-Draithus muster / death roll / theatre (IN DRAFT: `Flight.md`) — spiral on-page
2. Cath den night: powerlessness, “find someone worthier,” Cath refuses the break but does not counsel a new selfhood; sleep under the Red
3. Morning flight back; Cath orders return after duties; Dain dismounts at Riorson House (IN DRAFT — current chapter end)
4. **On the table (trashed from draft, reusable):** Brennan mending; “tired of existing” / “I don’t want to be Wingleader”; flight into Great Hall
...
Possible beats (to refine):
1. Concrete confrontations with specific harms (Violet distance maintained; other Marked/peer fallout; father as living reminder of complicity/legacy)
2. Leadership consequences of withdrawal: Wing friction, missing XO (Cianna → Bodhi already seeded), duty vs disappearance
3. Cath refuses both self-pity and self-destruction; brutish care intensifies as Dain’s risk of loss becomes clearer
4. Sloane’s curiosity hardens into something she hates noticing; interactions stop being “just” banter/business
5. Small public/private moments where someone clocks that Dain is changing — not redeemed yet, but no longer only his worst day

**Emotional result:** Accountability in motion. Softness is not free yet.

## Phase D — Graduation Horizon & Riorson Turn (late Arc 1)
**Job:** Close the academy-war chapter emotionally; open the larger hunt. Keep romance still slow — budding, not resolved.

Possible beats (placeholder-level only):
1. Turnover / graduation pressure; Dain’s relationship to rank clarified (not necessarily a clean quit; a redefined service)
2. Dain pulled into tracking Riorson as a key player (skills: discipline, memory-adjacent utility?, runes literacy?, leadership networks) — details TBD
3. Violet proximity returns through necessity (Riorson), not nostalgia — seed of later repair only
4. Sloane/Dain: mutual recognition of pull without full settlement; first-love atmosphere beginning
5. Cath: control and fondness visible as the same root; Dain feels less alone inside the bond

**Emotional result:** Liberated *enough* to keep going; appreciated by those who matter for Arc 1’s ending; romance alive and mutual but still early.

---

# Open Questions (fill as we go)
- [ ] Exact shape of Dain stepping back from Wing leadership without “quitting into nothing”
- [ ] How runes study is learned/practiced on-page (sessions with Sloane; Cat/Marin involvement)
- [ ] Which mistakes get full scenes vs referenced reckoning
- [ ] Father’s role on-page timing: antagonist, wound, political pressure, or all three (disownment already true in Dain’s reality)
- [ ] Aaric’s function beat-by-beat (friend, foil, dragon-bond mirror, mission partner)
- [ ] OC supporting roles: what gaps they fill
- [ ] Riorson-tracking plot mechanics (late; do not overbuild yet)
...
# Chapter Seeds (living)
### Ch 1 — Working title: Flight (TBD)
Status: drafted, unfinished
**Chapter job (narrow):** Dain’s mental health + Cath’s relationship with him. That is enough. Do not shove Arc 1 freight into this installment.
- Stage Dain’s deterioration (decayed foundation, uselessness, loneliness, loud hatred, bleak future)
- Stage Cath’s cindering fear / containment / advice-ban, readable only through bond + dialogue + emotion
- No Cath POV; no full prior-rider confession
- **Defer to later chapters:** Sloane romance gravity, runes path, Cat/Marin closeness, Violet repair seeds if they crowd the page, father as full scene, Riorson, systemic quadrant mental-health tour beyond what naturally touches Dain here

**Pacing rule:** Everything discussed in plotting can unfold across as many chapters as needed. Ch 1 is intimacy and collapse, not a prospectus.

**Dain’s interior (can deepen here; need not exhaust):**
- Decayed foundation; uselessness outside leadership; loneliness; loud hatred (Violet’s squad / Sloane / Liam); bleak future (disowned, front lines)
- **Loneliness flavor (theatre/Royce):** not empty-room loneliness. He is surrounded and working. He is a body doing leadership. No other prerogative. Royce reports to the title; Second Squad doesn’t answer to the man; Violet’s orbit doesn’t include him. The Violet fantasy = belonging + agency, not Violet herself. Seed: *alone inside the role, starting to want more than the role* (growth engine; do not fulfill here)

**Cath’s tells (hints only):**
- Fear flares Cath won’t name; refusal to advise; containment as care; recognition of a deadly pattern without human vocabulary for depression
- **On Dain’s BIG FEELINGS (wanting more):** Cath feels the size of it and cannot help; can only watch. Stamp/heat/presence without a path. In those moments he is only just a dragon. Never narrate as Cath POV.

Ends currently: after morning return to Riorson House; Cath will rest; Dain will come back after duties
**On the table:** Brennan / Hall / resignation blurt — usable later or as a later beat in this chapter if you want, not required
Needs: a close that stays inside Dain’s head + Cath’s bond pressure; any human “ask” only if it serves those two
